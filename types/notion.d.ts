/**
 * Copied from api-endpoints.d.ts by 2022-05-13
 */
...
declare type RichTextItemResponse = {
    type: "text";
    text: {
        content: string;
        link: {
...
declare type RollupFunction = "count" | "count_values" | "empty" | "not_empty" | "unique" | "show_unique" | "percent_empty" | "percent_not_empty" | "sum" | "average" | "median" | "min" | "max" | "range" | "earliest_date" | "latest_date" | "date_range" | "checked" | "unchecked" | "percent_checked" | "percent_unchecked" | "show_original";
...
// declare type PartialBlockObjectResponse = {
//     object: "block";
//     id: string;
// };
...
declare type BlockObjectRequestWithoutChildren = {
    embed: {
        url: string;
...
declare type TimestampCreatedTimeFilter = {
    created_time: DatePropertyFilter;
    timestamp: "created_time";
    type?: "created_time";
};
declare type TimestampLastEditedTimeFilter = {
    last_edited_time: DatePropertyFilter;
...
declare type GetPagePropertyPathParameters = {
    page_id: IdRequest;
    property_id: string;
};
declare type GetPagePropertyQueryParameters = {
    start_cursor?: string;
    page_size?: number;
};
export declare type GetPagePropertyParameters = GetPagePropertyPathParameters & GetPagePropertyQueryParameters;
...
export declare type GetBlockResponse = BlockObjectResponse;
...
export declare type UpdateBlockResponse = BlockObjectResponse;
...
export declare type DeleteBlockResponse = BlockObjectResponse;
...
export declare const updateDatabase: {
    ...
    readonly pathParams: readonly ["database_id"];
    readonly queryParams: readonly [];
    readonly bodyParams: readonly ["title", "icon", "cover", "properties", "archived"];
